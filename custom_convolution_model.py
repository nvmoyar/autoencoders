...
def decoding_conv_net(encoded_tensor):
    ...
    conv_layer = conv2d_upscale(x, 64, conv_ksize, conv_strides, pool_ksize, pool_strides, 'SAME')
    conv_layer = conv2d_upscale(conv_layer, 32, conv_ksize, conv_strides, pool_ksize, pool_strides, 'SAME')
    conv_layer = conv2d_upscale(conv_layer, 16, (1, 1), (1, 1), (1, 1), (1, 1), 'SAME')
    conv_layer = conv2d_upscale(conv_layer, 8, (1, 1), (1, 1), (1, 1), (1, 1), 'SAME')
    decoded = conv2d_upscale(conv_layer, 4, (2, 2), (2, 2), (2, 2), (1, 1), 'SAME')
